...
\begin{table}[htbp]
	...
	\begin{tabular}{l c c c}
		...
		F61 & 0 & 0 & 0 \\ 
		CF3x4 & -9629.8 & -7563.2 & -7456.3 \\ 
		Fnuc1 & -13312.4 & -9216.3 & -4067.7 \\ 
		F1x4 & -13500.9 & -12624.8 & -14605.1 \\ 
		Fnuc3 & -14439.6 & -12627.4 & -7740.2 \\ 
		F3x4 & -14832.9 & -16951.2 & -18663.3 \\ 
		\noalign{\smallskip}\hline\noalign{\smallskip} 
	\end{tabular}
	Note that all models have 3 free parameters. All values in table are the mean dAIC with F61 as the reference, as in best model fit. The ranking shown in table is the order for NP and Yeast, but note that polio is different. Even so, F61 provides the best model fit, although it certainly does not infer the most accurate $\omega$ values.
\end{table}
...
\begin{table}[htbp]
	\begin{tabular}{c c c c c c c}
		...
		Yeast & 0.022 & 0.006 & -0.062 & -0.079 & -0.062 & -0.072 \\ 
		Polio & -0.045 & -0.099 & -0.083 & -0.143 & -0.129 & -0.156 \\ 
		\noalign{\smallskip}\hline\noalign{\smallskip}
	\end{tabular}
\end{table}	
...
\begin{table}[htbp]
	\begin{tabular}{c c c c c c c}
		...
		Mutation rate & Fnuc1 & F1x4 & Fnuc3 & CF3x4 & F3x4 & F61 \\
		\hline\noalign{\smallskip}
		NP & 0.987 & 0.988 & 0.985 & 0.985 & 0.901 & 0.977 \\ 
		Yeast & 0.937 & 0.913 & 0.918 & 0.908 & 0.902 & 0.874 \\ 
		Polio & 0.870 & 0.841 & 0.796 & 0.777 & 0.771 & 0.801 \\ 
		\noalign{\smallskip}\hline\noalign{\smallskip}
	\end{tabular}
\end{table}	
