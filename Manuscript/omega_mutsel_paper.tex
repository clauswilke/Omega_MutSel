...
\title{The relationship between scaled selection coefficients and \emph{\normalsize{dN/dS}}}
...
\subsection*{Predicting \emph{\normalsize{dN/dS}} from scaled selection coefficients.} 
...
\subsection*{Relationship between \emph{\normalsize{dN/dS}} and scaled selection coefficients provides a novel benchmarking approach.}
