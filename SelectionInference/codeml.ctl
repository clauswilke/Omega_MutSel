* 8/28/13 SJS. Runs PAML M8 model, preserving masked sites.
    ...
    CodonFreq = 3  * 0:1/61 each, 1:F1X4, 2:F3X4, 3:codon table
        ...
        model = 0  * 0 means one w ratio for all branches
                   * models for codons:
                       * 0:one for whole tree, 1:1 for each branch, 2:2 or more dN/dS ratios for branches
